...
const EditDish = () => {
    ...
    const restaurant_Id = useParams().dish_Id;
    console.log("restaurant_Id", restaurant_Id);
    const newDish = useSelector((state) => state.newDish || {});
    const { loading, dish, error } = newDish;
    ...
    const handleSubmit = async (e) => {
        ...
        dispatch(createDish(restaurant_Id, newData));
        navigate('/restaurant_dashboard');
    };
